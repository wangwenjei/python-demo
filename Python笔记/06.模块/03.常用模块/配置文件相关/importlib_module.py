...
print(
    setting)  # ==> <module 'myfile.setting' from '/Users/shaun/Healife/python/python-demo/document/06.模块/配置文件相关/myfile/setting.py'>
...
print(
    res)  # ==> <module 'myfile.setting' from '/Users/shaun/Healife/python/python-demo/document/06.模块/配置文件相关/myfile/setting.py'>
