...
"""===>
<socket.socket fd=5, family=AddressFamily.AF_INET, type=SocketKind.SOCK_STREAM, proto=0, laddr=('127.0.0.1', 8085), raddr=('127.0.0.1', 56698)>
...
print('来自客户端发送的消息', data.decode('utf-8'))  # ==> 来自客户端发送的消息 Hello Jason 嗯
